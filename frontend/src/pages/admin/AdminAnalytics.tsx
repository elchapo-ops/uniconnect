            ...
            <DashboardLayout navItems={navItems} title="Analytics">
                <Card>
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Please make sure the backend server is running.</p>
                    </CardContent>
                </Card>
            </DashboardLayout>
        );
                        ...
                        <Card>
                            <CardContent className="p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-2xl font-bold">{stats.activeEmployers}</p>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {stats.applicationsByStatus?.length > 0 ? (
                                    <div className="h-48">
                                        <ResponsiveContainer width="100%" height="100%">
                                            <BarChart data={stats.applicationsByStatus} layout="vertical">
                                                <CartesianGrid strokeDasharray="3 3" />
                                                <XAxis type="number" />
